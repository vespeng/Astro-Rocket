...
`src/content/projects/en/astro-rocket.mdx` carries a ready-to-uncomment video slide as a starting point. Drop a file in `public/videos/`, point a slide at it, give it a poster — done.
